...
#include "config.h"
#include "OledDisplay.h" // Include your new header file
...
void setup() {
    ...
    myDisplay.begin(); // Initialize the OLED Display
}
...
void loop() {
    ...
    if (lora_idle == true) {
        ...
        myDisplay.displayData(temperature, humidity, soilMoisture, mq2Reading,
                              waterDetected, flameSensor, objectTemp,
                              ambientTemp); // Update OLED with sensor data
